...
import {
  MqttMessage, makePublishEvent, rendererEvents, rendererRpc, readFromFile,
...
export const openFile = (encoding: BufferEncoding = 'utf8') => async (dispatch: Dispatch<any>, getState: () => AppState) => {
  try {
