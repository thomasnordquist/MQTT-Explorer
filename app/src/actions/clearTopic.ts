...
import { makePublishEvent, rendererEvents } from 'MQTT-Explorer/events/events'
...
export const clearTopic = (topic: q.TreeNode<any>, recursive: boolean) => async (dispatch: Dispatch<any>, getState: () => AppState) => {
  ...
  if (recursive) {
    ...
    const childTopicsMessage = topicCount + topicDelta > 0
